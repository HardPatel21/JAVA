...
public class Department_2 extends BaseEntity{
    private String deptName;
    private Employee_2[] employees;
    private int employeeCount;

    public Department_2(int id, String deptName, int maxEmployees) {
        this.id = id;
        this.deptName = deptName;
        this.employees = new Employee_2[maxEmployees];
        this.employeeCount = 0;
    }

    public void addEmployee(Employee_2 emp) {
